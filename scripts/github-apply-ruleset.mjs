...
if(!execute){console.log('Dry run only. Add --execute to run.'); process.exit(0)}
const res=spawnSync('gh',['api',`repos/${owner}/${repo}/rulesets`,'-X','POST','--input',payload],{stdio:'inherit'});
